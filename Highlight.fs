...
HEX
CREATE RGB-COLORS
808000 , \ NAME-CATEGORY
008000 , \ NUMBER-CATEGORY
800000 , \ STRING-CATEGORY
800080 , \ COMMENT-CATEGORY
800080 , \ LINE-COMMENT-CATEGORY
008080 , \ NEW-WORD-CATEGORY
4682B4 , \ DEFINING-CATEGORY
0000FF , \ OPERATOR-CATEGORY
FF8C00 , \ CONTROL-CATEGORY
66CDAA , \ STACK-CATEGORY
808000 , \ ADDRESS-CATEGORY
DECIMAL
...
: .TOKEN ( addr # -- )
    ...
    ELSE
        DEFINING @ IF
            ...
            DEFINING-CATEGORY CATEGORY>COLOR _COLOR
            DEFINING OFF
        ELSE
            2DUP FIND-NAME IF
                NORMAL
...
: ?OUTPUT-ARG
    ARGC @ 0 ?DO
        I ARG S" HTML" COMPARE 0= IF TRUE HTML ! DEFINE-COLOR THEN 
    LOOP ;
